...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (!selectedValuesAreDefault) {
            ...
            // SG change
            if(showSeconds){
            	minText = String.valueOf(Utilities.secondsToTimer((Integer) getSelectedMinValue()));
            	maxText = String.valueOf(Utilities.secondsToTimer((Integer) getSelectedMaxValue()));
            }else{
            ...
            canvas.drawText(maxText,
                            ...
                            mDistanceToTop + mTextSize * 1.5f,
                            paint);
        }

    }
    
    public void setUserValuesAsString(boolean showSeconds){
