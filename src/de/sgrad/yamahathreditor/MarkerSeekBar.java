 ...
 * @see MarkerView
 */
public class MarkerSeekBar extends SeekBar implements SeekBar.OnSeekBarChangeListener {

    private static final int ANIMATION_SHOW_DURATION = 300;  // 300
    private static final int MARKER_TOGGLE_DELAY = 50;  // 333
    private static final int ANIMATION_HIDE_DURATION = 100;  //200
